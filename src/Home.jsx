    ...
    <div class="container">
        ...
        <footer class="foot">
            <div class="footer_cont txt">
                <p>Gobernación del Tolima <br />
                    Ibagué - Capital Musical de Colombia</p>
                <p>@2021 Copyright - Team Seven</p>
                <p>info_catastro@ibague.com.co<br />
                    Conmutador: 608-7654321 Extensión: 12345 </p>
            </div>
        </footer>
    </div>
  );
